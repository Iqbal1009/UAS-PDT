<div class="wrapper">
  ...
  <nav id="sidebar">
    <div class="sidebar-header">
      <img src="<?= base_url('assets/img/img_properties/tasik.jpeg'); ?>" alt="logo" class="img-fluid">
    </div>
        <?php 
    ...
    <ul class="list-unstyled">
        <p>Made in &copy; By seblak Tasik </p>
      </li>
    </ul>
  </nav>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <button type="button" id="sidebarCollapse" class="btn merah-baru">
          <i class="fas fa-align-left"></i> | Selamat Datang 
